...
Testa:
1. Endpoint JWT token (/api/token/)
2. Endpoint de bootstrap de organizações (/api/user/organizations/)
...
def test_jwt_endpoint():
    ...
    if response.status_code == 200:
        print(f"  ✓ POST /api/token/ retornou status 200")
        ...
        print(f"  ✗ POST /api/token/ retornou status {response.status_code}")
...
def test_user_organizations_endpoint():
    ...
    print("\n✓ Testando User Organizations Bootstrap Endpoint...")
    ...
    if response.status_code == 200:
        print(f"  ✓ GET /api/user/organizations/ retornou status 200")
        orgs = response.json()
        ...
        print(f"  ✗ GET /api/user/organizations/ retornou status {response.status_code}")
        print(f"  Response: {response.json()}")
        return False
