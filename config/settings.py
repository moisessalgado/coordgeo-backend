...
INSTALLED_APPS = [
    ...
    'projects', # Add the projects app to the installed apps
    'data', # Add the data app to the installed apps
    'permissions', # Add the permissions app to the installed apps
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / "templates"], # Add the templates directory to the template search path
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
DATABASES = {
    ...
    "default": {
        ...
        "TEST": {
            "NAME": config('DB_TEST_NAME', default='test_geodjango'),
            "TEMPLATE": "template_postgis", # Use PostGIS template for test database to ensure spatial extensions are available
        },
    }
}
...
# Explicit JWT settings to avoid relying on library defaults.
SIMPLE_JWT = {
...
CORS_ALLOW_HEADERS = [
    ...
    "x-csrftoken",
    "x-requested-with",
    "x-organization-id",  # Allow custom organization header
]
