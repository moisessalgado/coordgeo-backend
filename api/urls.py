...
from accounts.views import UserViewSet, UserOrganizationsView, UserDefaultOrganizationView, UserProfileView, RegisterView
...
urlpatterns = [
    ...
    path('user/default-organization/', UserDefaultOrganizationView.as_view(), name='user_default_organization'),
]
